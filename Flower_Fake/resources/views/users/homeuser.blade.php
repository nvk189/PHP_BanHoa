            ...
            <div class="flower-item  row grid wide">
                ...
                <div class="flower-items  col l-3 m-4 c-6">
                    ...
                    <div class="img-flower">
                        <img class="img" src="{{ asset('user/assets/img/' . $ne->pr_image) }}" alt="">
                    </div>
                    <div class="text-flower">
                        <p class="name-flower">{{ $ne->pr_name }}</p>
                        @if($ne->pr_sales)
                        <span class="price-sale">{{ number_format($ne->pr_sales , 0, ',', '.') }} VND</span>
                        <span class="price">{{ number_format( $ne->pr_price, 0, ',', '.') }} VND</span>
                        @else
                        <span class="price-sale">{{ number_format($ne->pr_price , 0, ',', '.') }} VND</span>
                        @endif
                    </div>
                    <div class="sub-item">
                        <a href="{{ url("home/product/{$ne->pr_id}") }}">
                            Đặt hàng
                        </a>
                        <a style="background-color: blue;" href="{{ url('cart', ['pr_id' => $ne->pr_id]) }} }}">
                            + giỏ hàng
                        </a>
                    ...
                    <div class="number_sales">
                        {{ 100- ( $ne->pr_sales/ $ne->pr_price)*100 }}%
                    </div>
                    @endif
