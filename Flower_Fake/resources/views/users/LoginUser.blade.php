        ...
        <div class="l-9 " style="display: flex;">
            <div class="l-6" style="padding: 0 12px 0 0;">
                <div class="login-1" style="padding: 16px;">
                    ...
                    <br>
                    <br>
                    <p class="btn-continue"><a href="/user/register">Tiếp tục</a></p>
                </div>
            </div>
                    ...
                    <form id="target" action="#" method="post" style="padding: 16px;">
                        ...
                        <form action="" method="POST">
                            ...
                            <p>
                                ...
                                <input name="name" id="name" type="email" class="input-email" placeholder="Nhập địa chỉ email..." required>
                            ...
                            <p>
                                ...
                                <input name="password" id="password" type="password" class="input-email" placeholder="Mật khẩu" required>
