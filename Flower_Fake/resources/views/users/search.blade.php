    ...
    <div class="list-product">
        <div class="grid wide product-list-item">
            <h1>
                ...
                <span class="text-product">sản phẩm tìm kiếm</span>
            </h1>
            <div class="menu-list-product" style="margin-bottom: 50px;">
                ...
                <div class="page-list">
                    ...
                    <div class="number-text">
                        ...
                        <select id="input-sort" class="form-select" onchange="redirectToSelectedOption()">
                            <option value="{{ url('product_user/asc') }}">Giá (Thấp -> Cao)</option>
                            <option value="{{ url('product_user/desc') }}">Giá (Cao -> Thấp)</option>
                        </select>
                    </div>
                </div>
            </div>
